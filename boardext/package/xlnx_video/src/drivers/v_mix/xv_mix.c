 ...
 */
uint32_t XV_mix_Get_FlushDone(XV_mix *InstancePtr) {
    uint32_t Data;
...
void XV_mix_Set_HwReg_layer1_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer1_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer1_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer1_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer1_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER1_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer1_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer2_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer2_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer2_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer2_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 */
void XV_mix_Set_HwReg_layer2_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer2_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER2_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer3_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
void XV_mix_Set_HwReg_layer3_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer3_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr must be initialized and ready (IsReady == XIL_COMPONENT_IS_READY).
 */
void XV_mix_Set_HwReg_layer3_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer3_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER3_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer4_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer4_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer4_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer4_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer4_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer4_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER4_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer5_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer5_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer5_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer5_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer5_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer5_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER5_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer6_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer6_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer6_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer6_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer6_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer6_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER6_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer7_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer7_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer7_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer7_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer7_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer7_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER7_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer8_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer8_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer8_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer8_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 * @param Data        64-bit value to write to the register.
 */
void XV_mix_Set_HwReg_layer8_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer8_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER8_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer9_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer9_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer9_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer9_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 */
void XV_mix_Set_HwReg_layer9_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer9_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER9_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer10_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer10_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer10_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer10_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 * @param Data        64-bit value to write to the hardware register.
 */
void XV_mix_Set_HwReg_layer10_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer10_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER10_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer11_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer11_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer11_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer11_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 * @param Data        64-bit value to write to the register.
 */
void XV_mix_Set_HwReg_layer11_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer11_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER11_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer12_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer12_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer12_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer12_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 * @param Data        64-bit value to write to the register.
 */
void XV_mix_Set_HwReg_layer12_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer12_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER12_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer13_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer13_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer13_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer13_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - The XV_mix instance must be ready (IsReady == XIL_COMPONENT_IS_READY).
 */
void XV_mix_Set_HwReg_layer13_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer13_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER13_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer14_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer14_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer14_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer14_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer14_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer14_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER14_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer15_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer15_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer15_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer15_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr->IsReady must be set to XIL_COMPONENT_IS_READY.
 */
void XV_mix_Set_HwReg_layer15_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer15_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER15_BUF3_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer16_buf1_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF1_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF1_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer16_buf1_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF1_V_DATA + 4) << 32;
    return Data;
}
...
void XV_mix_Set_HwReg_layer16_buf2_V(XV_mix *InstancePtr, uint64_t Data) {
    ...
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF2_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF2_V_DATA + 4, (uint32_t)(Data >> 32));
}
...
uint64_t XV_mix_Get_HwReg_layer16_buf2_V(XV_mix *InstancePtr) {
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF2_V_DATA + 4) << 32;
    return Data;
}
 ...
 *   - InstancePtr must be initialized and ready (IsReady == XIL_COMPONENT_IS_READY).
 */
void XV_mix_Set_HwReg_layer16_buf3_V(XV_mix *InstancePtr, uint64_t Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF3_V_DATA, (uint32_t)(Data));
    XV_mix_WriteReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF3_V_DATA + 4, (uint32_t)(Data >> 32));
}
 ...
 */
uint64_t XV_mix_Get_HwReg_layer16_buf3_V(XV_mix *InstancePtr) {
    uint64_t Data;
    ...
    Data += (uint64_t)XV_mix_ReadReg(InstancePtr->Config.BaseAddress, XV_MIX_CTRL_ADDR_HWREG_LAYER16_BUF3_V_DATA + 4) << 32;
    return Data;
}
