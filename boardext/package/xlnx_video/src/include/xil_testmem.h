...
extern uint32_t Xil_TestMem32(uint32_t AddrLow, uint32_t AddrHigh, uint32_t Words, uint32_t Pattern, uint8_t Subtest);
extern uint32_t Xil_TestMem16(uint32_t AddrLow, uint32_t AddrHigh, uint32_t Words, uint16_t Pattern, uint8_t Subtest);
extern uint32_t Xil_TestMem8(uint32_t AddrLow, uint32_t AddrHigh, uint32_t Words, uint8_t Pattern, uint8_t Subtest);
#else
extern uint32_t Xil_TestMem32(uint32_t *Addr, unsigned long Words, uint32_t Pattern, uint8_t Subtest);
extern uint32_t Xil_TestMem16(uint16_t *Addr, unsigned long Words, uint16_t Pattern, uint8_t Subtest);
extern uint32_t Xil_TestMem8(uint8_t *Addr, unsigned long Words, uint8_t Pattern, uint8_t Subtest);
#endif
