...
*/
typedef void (*XDcfg_IntrHandler) (void *CallBackRef, uint32_t Status);
...
typedef struct {
	...
	uint32_t IsStarted;		/**< Device Configuration Interface
				  * is running
				  */
...
*
* @note		C-style signature:
*		uint32_t XDcfg_ReadMultiBootConfig(XDcfg* InstancePtr)
*
*****************************************************************************/
...
int XDcfg_CfgInitialize(XDcfg *InstancePtr,
			XDcfg_Config *ConfigPtr, uint32_t EffectiveAddress);

void XDcfg_EnablePCAP(XDcfg *InstancePtr);

void XDcfg_DisablePCAP(XDcfg *InstancePtr);

void XDcfg_SetControlRegister(XDcfg *InstancePtr, uint32_t Mask);

void XDcfg_ClearControlRegister(XDcfg *InstancePtr, uint32_t Mask);

uint32_t XDcfg_GetControlRegister(XDcfg *InstancePtr);

void XDcfg_SetLockRegister(XDcfg *InstancePtr, uint32_t Data);

uint32_t XDcfg_GetLockRegister(XDcfg *InstancePtr);

void XDcfg_SetConfigRegister(XDcfg *InstancePtr, uint32_t Data);

uint32_t XDcfg_GetConfigRegister(XDcfg *InstancePtr);

void XDcfg_SetStatusRegister(XDcfg *InstancePtr, uint32_t Data);

uint32_t XDcfg_GetStatusRegister(XDcfg *InstancePtr);

void XDcfg_SetRomShadowRegister(XDcfg *InstancePtr, uint32_t Data);

uint32_t XDcfg_GetSoftwareIdRegister(XDcfg *InstancePtr);

void XDcfg_SetMiscControlRegister(XDcfg *InstancePtr, uint32_t Mask);

uint32_t XDcfg_GetMiscControlRegister(XDcfg *InstancePtr);

uint32_t XDcfg_IsDmaBusy(XDcfg *InstancePtr);

void XDcfg_InitiateDma(XDcfg *InstancePtr, uint32_t SourcePtr, uint32_t DestPtr,
		       uint32_t SrcWordLength, uint32_t DestWordLength);

uint32_t XDcfg_Transfer(XDcfg *InstancePtr,
		   void *SourcePtr, uint32_t SrcWordLength,
		   void *DestPtr, uint32_t DestWordLength,
		   uint32_t TransferType);

/*
 * Interrupt related function prototypes implemented in xdevcfg_intr.c
 */
void XDcfg_IntrEnable(XDcfg *InstancePtr, uint32_t Mask);

void XDcfg_IntrDisable(XDcfg *InstancePtr, uint32_t Mask);

uint32_t XDcfg_IntrGetEnabled(XDcfg *InstancePtr);

uint32_t XDcfg_IntrGetStatus(XDcfg *InstancePtr);

void XDcfg_IntrClear(XDcfg *InstancePtr, uint32_t Mask);
