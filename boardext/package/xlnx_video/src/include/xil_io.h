...
*
******************************************************************************/
static INLINE uint64_t Xil_In64(uintptr_t Addr)
{
...
*
******************************************************************************/
static INLINE void Xil_Out64(uintptr_t Addr, uint64_t Value)
{
 ...
 *
 *****************************************************************************/
static INLINE int Xil_SecureOut32(uintptr_t Addr, uint32_t Value)
{
...
#if defined (__MICROBLAZE__)
#ifdef __LITTLE_ENDIAN__
static INLINE uint16_t Xil_In16BE(uintptr_t Addr) /**< Static inline function to Read
                                                Register of 16 Bits in Big Endian */
#else
static INLINE uint16_t Xil_In16LE(uintptr_t Addr) /**< Static inline function to Read
...
**********************************************************************************/
static INLINE uint16_t Xil_In16BE(uintptr_t Addr)
#endif
{
...
**********************************************************************************/
static INLINE uint32_t Xil_In32BE(uintptr_t Addr)
#endif
{
...
**********************************************************************************/
static INLINE void Xil_Out16BE(uintptr_t Addr, uint16_t Value)
#endif
{
...
#if defined (__MICROBLAZE__)
#ifdef __LITTLE_ENDIAN__
static INLINE void Xil_Out32BE(uintptr_t Addr, uint32_t Value) /**< Static inline function to write
                                                Register of 32 Bits in Big Endian */
#else
static INLINE void Xil_Out32LE(uintptr_t Addr, uint32_t Value) /**< Static inline function to write
                                                Register of 32 Bits in Little Endian */
#endif
#else
/**
* Static inline function to Read Register of 16 Bits in Big Endian.
**********************************************************************************/
static INLINE void Xil_Out32BE(uintptr_t Addr, uint32_t Value)
#endif
{
