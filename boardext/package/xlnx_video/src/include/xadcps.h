...
*						xadcps.c (CR#854437).
*       ms     01/23/17 Added printf statement in main function for all
...
*
* @note		C-Style signature:
*		float XAdcPs_RawToTemperature(uint32_t AdcData);
*
*****************************************************************************/
...
*
* @note		C-Style signature:
*		float XAdcPs_RawToVoltage(uint32_t AdcData);
*
*****************************************************************************/
...
*
* @note		C-Style signature:
*		void XAdcPs_WriteFifo(XAdcPs *InstancePtr, uint32_t Data);
*
*****************************************************************************/
...
*
* @note		C-Style signature:
*		uint32_t XAdcPs_ReadFifo(XAdcPs *InstancePtr);
*
*****************************************************************************/
...
#else
XAdcPs_Config *XAdcPs_LookupConfig(uint32_t BaseAddress);
#endif
...
void XAdcPs_SetConfigRegister(XAdcPs *InstancePtr, uint32_t Data);
uint32_t XAdcPs_GetConfigRegister(XAdcPs *InstancePtr);

uint32_t XAdcPs_GetMiscStatus(XAdcPs *InstancePtr);

void XAdcPs_SetMiscCtrlRegister(XAdcPs *InstancePtr, uint32_t Data);
uint32_t XAdcPs_GetMiscCtrlRegister(XAdcPs *InstancePtr);

void XAdcPs_Reset(XAdcPs *InstancePtr);

uint16_t XAdcPs_GetAdcData(XAdcPs *InstancePtr, uint8_t Channel);

uint16_t XAdcPs_GetCalibCoefficient(XAdcPs *InstancePtr, uint8_t CoeffType);

uint16_t XAdcPs_GetMinMaxMeasurement(XAdcPs *InstancePtr, uint8_t MeasurementType);

void XAdcPs_SetAvg(XAdcPs *InstancePtr, uint8_t Average);
uint8_t XAdcPs_GetAvg(XAdcPs *InstancePtr);
...
void XAdcPs_SetAlarmEnables(XAdcPs *InstancePtr, uint16_t AlmEnableMask);
uint16_t XAdcPs_GetAlarmEnables(XAdcPs *InstancePtr);

void XAdcPs_SetCalibEnables(XAdcPs *InstancePtr, uint16_t Calibration);
uint16_t XAdcPs_GetCalibEnables(XAdcPs *InstancePtr);

void XAdcPs_SetSequencerMode(XAdcPs *InstancePtr, uint8_t SequencerMode);
uint8_t XAdcPs_GetSequencerMode(XAdcPs *InstancePtr);

void XAdcPs_SetAdcClkDivisor(XAdcPs *InstancePtr, uint8_t Divisor);
uint8_t XAdcPs_GetAdcClkDivisor(XAdcPs *InstancePtr);

int XAdcPs_SetSeqChEnables(XAdcPs *InstancePtr, uint32_t ChEnableMask);
uint32_t XAdcPs_GetSeqChEnables(XAdcPs *InstancePtr);

int XAdcPs_SetSeqAvgEnables(XAdcPs *InstancePtr, uint32_t AvgEnableChMask);
uint32_t XAdcPs_GetSeqAvgEnables(XAdcPs *InstancePtr);

int XAdcPs_SetSeqInputMode(XAdcPs *InstancePtr, uint32_t InputModeChMask);
uint32_t XAdcPs_GetSeqInputMode(XAdcPs *InstancePtr);

int XAdcPs_SetSeqAcqTime(XAdcPs *InstancePtr, uint32_t AcqCyclesChMask);
uint32_t XAdcPs_GetSeqAcqTime(XAdcPs *InstancePtr);

void XAdcPs_SetAlarmThreshold(XAdcPs *InstancePtr, uint8_t AlarmThrReg, uint16_t Value);
uint16_t XAdcPs_GetAlarmThreshold(XAdcPs *InstancePtr, uint8_t AlarmThrReg);
...
void XAdcPs_SetMuxMode(XAdcPs *InstancePtr, int MuxMode, uint8_t Channel);

void XAdcPs_SetPowerdownMode(XAdcPs *InstancePtr, uint32_t Mode);

uint32_t XAdcPs_GetPowerdownMode(XAdcPs *InstancePtr);
 ...
 */
void XAdcPs_IntrEnable(XAdcPs *InstancePtr, uint32_t Mask);
void XAdcPs_IntrDisable(XAdcPs *InstancePtr, uint32_t Mask);
uint32_t XAdcPs_IntrGetEnabled(XAdcPs *InstancePtr);

uint32_t XAdcPs_IntrGetStatus(XAdcPs *InstancePtr);
void XAdcPs_IntrClear(XAdcPs *InstancePtr, uint32_t Mask);
