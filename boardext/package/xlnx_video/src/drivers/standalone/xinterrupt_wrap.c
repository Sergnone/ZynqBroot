...
*
******************************************************************************/
int XConfigInterruptCntrl(uintptr_t IntcParent)
{
#if defined (XPAR_AXI_INTC) || defined (XPAR_SCUGIC)
	int Status = XST_FAILURE;
	uintptr_t BaseAddr = XGet_BaseAddr(IntcParent);
#endif
...
*
******************************************************************************/
int XConnectToInterruptCntrl(uint32_t IntrId, void *IntrHandler, void *CallBackRef, uintptr_t IntcParent)
{
	int Status = XST_FAILURE;
#if !defined (XPAR_AXI_INTC) && !defined (XPAR_SCUGIC)
	(void)IntrId;
	...
	if (XGet_IntcType(IntcParent) == XINTC_TYPE_IS_SCUGIC) {
		...
		if (Doconnect) {
			uint16_t IntrNum = XGet_IntrId(IntrId);
			uint16_t Offset = XGet_IntrOffset(IntrId);
...
int XConnectToFastInterruptCntrl(uint32_t IntrId, void *IntrHandler, uintptr_t IntcParent)
{
	int Status = XST_FAILURE;
#if !defined (XPAR_AXI_INTC)
	(void)IntrId;
...
*
******************************************************************************/
int XDisconnectInterruptCntrl(uint32_t IntrId, uintptr_t IntcParent)
{
...
*
******************************************************************************/
int XStartInterruptCntrl(uint32_t Mode, uintptr_t IntcParent)
{
#if defined (XPAR_AXI_INTC)
	int Status = XST_FAILURE;
#else
...
*
******************************************************************************/
void XEnableIntrId( uint32_t IntrId, uintptr_t IntcParent)
{
#if !defined (XPAR_SCUGIC) && !defined (XPAR_AXI_INTC)
        (void)IntrId;
#endif
...
*
******************************************************************************/
void XDisableIntrId( uint32_t IntrId, uintptr_t IntcParent)
{
#if !defined (XPAR_SCUGIC) && !defined (XPAR_AXI_INTC)
        (void)IntrId;
#endif
...
*
******************************************************************************/
void XSetPriorityTriggerType( uint32_t IntrId, uint8_t Priority, uintptr_t IntcParent)
{
	uint8_t Trigger = (((XGet_TriggerType(IntrId) == 1) ||
...
*
******************************************************************************/
void XGetPriorityTriggerType( uint32_t IntrId, uint8_t *Priority, uint8_t *Trigger,  uintptr_t IntcParent)
{
	if (XGet_IntcType(IntcParent) == XINTC_TYPE_IS_SCUGIC) {
		uint16_t IntrNum = XGet_IntrId(IntrId);
		uint16_t Offset = XGet_IntrOffset(IntrId);
...
*
******************************************************************************/
void XStopInterruptCntrl( uintptr_t IntcParent)
{
	if (XGet_IntcType(IntcParent) == XINTC_TYPE_IS_SCUGIC) {
#if defined (XPAR_SCUGIC)
...
*
******************************************************************************/
void XRegisterInterruptHandler(void *IntrHandler,  uintptr_t IntcParent)
{
#if !defined (XPAR_SCUGIC) && !defined (XPAR_AXI_INTC)
	(void)IntrHandler;
#endif
...
*
******************************************************************************/
int XSetupInterruptSystem(void *DriverInstance, void *IntrHandler, uint32_t IntrId,  uintptr_t IntcParent,
			  uint16_t Priority)
{
	int Status;
...
*
******************************************************************************/
int32 XGetEncodedIntrId(uint32_t LegacyIntrId, uint32_t TriggerType, uint8_t IntrType, uint8_t IntcType, uint32_t *IntrId )
{
	int32 Status = XST_FAILURE;
...
*
******************************************************************************/
int32 XTriggerSoftwareIntr(uint32_t IntrId, uintptr_t IntcParent, uint32_t Cpu_Id)
{
	int32 Status = XST_SUCCESS;
	uint16_t IntrNum = XGet_IntrId(IntrId);
#if !defined (XPAR_SCUGIC) && !defined (XPAR_AXI_INTC)
	(void) IntrNum;
	(void) Cpu_Id;
