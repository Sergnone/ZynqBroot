...
static uint32_t XVidC_EdidIsVideoTimingSupportedPreferredTiming(const uint8_t *EdidRaw,
		const XVidC_VideoTimingMode *VtMode);
static uint32_t XVidC_EdidIsVideoTimingSupportedEstablishedTimings(const uint8_t *EdidRaw,
		const XVidC_VideoTimingMode *VtMode);
static uint32_t XVidC_EdidIsVideoTimingSupportedStandardTimings(const uint8_t *EdidRaw,
		const XVidC_VideoTimingMode *VtMode);
static int XVidC_CalculatePower(uint8_t Base, uint8_t Power);
static int XVidC_CalculateBinaryFraction_QFormat(uint16_t Val, uint8_t DecPtIndex);
 ...
 *
*******************************************************************************/
void XVidC_EdidGetManName(const uint8_t *EdidRaw, char ManName[4])
{
 ...
 *
*******************************************************************************/
XVidC_ColorDepth XVidC_EdidGetColorDepth(const uint8_t *EdidRaw)
{
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcRedX(const uint8_t *EdidRaw)
{
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcRedY(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcGreenX(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcGreenY(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcBlueX(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcBlueY(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcWhiteX(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
int XVidC_EdidGetCcWhiteY(const uint8_t *EdidRaw)
{
	return XVidC_CalculateBinaryFraction_QFormat(
 ...
 *
*******************************************************************************/
uint16_t XVidC_EdidGetStdTimingsV(const uint8_t *EdidRaw, uint8_t StdTimingsNum)
{
	uint16_t V;
 ...
 *
*******************************************************************************/
uint32_t XVidC_EdidIsVideoTimingSupported(const uint8_t *EdidRaw,
		const XVidC_VideoTimingMode *VtMode)
{
	uint32_t Status;
		...
		const XVidC_VideoTimingMode *VtMode)
{
	...
	for (Index = 0; Index < 8; Index++) {
		if ((VtMode->Timing.HActive ==
			...
			(VtMode->FrameRate == (uint8_t)XVidC_EdidGetStdTimingsFrr(
							EdidRaw, Index + 1))) {
			return XST_SUCCESS;
		}
	}
