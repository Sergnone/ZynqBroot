...
*		void XScuTimer_SetLoadReg(uint32_t BaseAddr, uint32_t Value)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		uint32_t XScuTimer_GetLoadReg(uint32_t BaseAddr)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		void XScuTimer_SetCounterReg(uint32_t BaseAddr, uint32_t Value)
*
******************************************************************************/
...
*
* @note		C-style signature:
		uint32_t XScuTimer_GetCounterReg(uint32_t BaseAddr)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		void XScuTimer_SetControlReg(uint32_t BaseAddr, uint32_t Value)
*
******************************************************************************/
...
*
* @note		C-style signature:
		uint32_t XScuTimer_GetControlReg(uint32_t BaseAddr)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		void XScuTimer_SetIntrReg(uint32_t BaseAddr, uint32_t Value)
*
******************************************************************************/
...
*
* @note		C-style signature:
		uint32_t XScuTimer_GetIntrReg(uint32_t BaseAddr)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		uint32_t XScuTimer_ReadReg(uint32_t BaseAddr, uint32_t RegOffset)
*
*****************************************************************************/
...
*
* @note		C-style signature:
*		void XScuTimer_WriteReg(uint32_t BaseAddr, uint32_t RegOffset, uint32_t Data)
*
*****************************************************************************/
