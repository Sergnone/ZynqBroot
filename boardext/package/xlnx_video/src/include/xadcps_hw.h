...
*		uint32_t XAdcPs_ReadReg(uint32_t BaseAddress, uint32_t RegOffset);
*
******************************************************************************/
...
*
* @note 	C-style Signature:
*		void XAdcPs_WriteReg(uint32_t BaseAddress,
...
*
* @note 	C-style Signature:
*		void XAdcPs_FormatWriteData(uint32_t RegOffset,
*					     uint16_t Data, int ReadWrite)
*
******************************************************************************/
