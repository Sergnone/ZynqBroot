...
* 1.00a wre  01/25/07 Added Linux style data types uint32_t, uint16_t, uint8_t, TRUE, FALSE
* 1.00a rpm  04/02/07 Added ifndef KERNEL around uint32_t, uint16_t, uint8_t data types
* </pre>
*
******************************************************************************/
