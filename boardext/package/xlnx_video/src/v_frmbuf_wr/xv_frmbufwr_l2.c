...
******************************************************************************/
#ifndef SDT
int XVFrmbufWr_Initialize(XV_FrmbufWr_l2 *InstancePtr, uint16_t DeviceId)
#else
int XVFrmbufWr_Initialize(XV_FrmbufWr_l2 *InstancePtr, uintptr_t BaseAddress)
#endif
{
  int Status;
...
*
******************************************************************************/
void XVFrmbufWr_InterruptEnable(XV_FrmbufWr_l2 *InstancePtr, uint32_t IrqMask)
{
...
*
******************************************************************************/
void XVFrmbufWr_InterruptDisable(XV_FrmbufWr_l2 *InstancePtr, uint32_t IrqMask)
{
  Xil_AssertVoid(InstancePtr != NULL);
...
*
******************************************************************************/
uintptr_t XVFrmbufWr_GetBufferAddr(XV_FrmbufWr_l2 *InstancePtr)
{
  uintptr_t ReadVal = 0;
...
*
******************************************************************************/
uintptr_t XVFrmbufWr_GetChromaBufferAddr(XV_FrmbufWr_l2 *InstancePtr)
{
  uintptr_t ReadVal = 0;
...
*
******************************************************************************/
uintptr_t XVFrmbufWr_GetVChromaBufferAddr(XV_FrmbufWr_l2 *InstancePtr)
{
  uintptr_t ReadVal = 0;
  Xil_AssertNonvoid(InstancePtr != NULL);
...
*
******************************************************************************/
uint32_t XVFrmbufWr_GetFieldID(XV_FrmbufWr_l2 *InstancePtr)
{
  uint32_t ReadVal = 0;
