...
typedef struct
{
	...
	uintptr_t DistBaseAddress;	/**< Distributor Register base address */
	uintptr_t CpuBaseAddress;	/**< CPU Interface Register base address */
...
int32_t  XScuGic_CfgInitialize(XScuGic *InstancePtr, XScuGic_Config *ConfigPtr,
...
XScuGic_Config *XScuGic_LookupConfig(uintptr_t BaseAddr);
 ...
 */
int32_t  XScuGic_SelfTest(XScuGic *InstancePtr);
