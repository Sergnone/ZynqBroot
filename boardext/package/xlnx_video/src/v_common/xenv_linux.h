...
#define XCACHE_INVALIDATE_DCACHE_RANGE(Addr, Len) invalidate_dcache_range((uint32_t)(Addr), ((uint32_t)(Addr)+(Len)))
#define XCACHE_FLUSH_DCACHE_RANGE(Addr, Len)      flush_dcache_range((uint32_t)(Addr), ((uint32_t)(Addr)+(Len)))
