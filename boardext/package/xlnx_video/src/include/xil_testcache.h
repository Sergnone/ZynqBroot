...
extern uint32_t Xil_TestDCacheRange(void);
extern uint32_t Xil_TestDCacheAll(void);
extern uint32_t Xil_TestICacheRange(void);
extern uint32_t Xil_TestICacheAll(void);
