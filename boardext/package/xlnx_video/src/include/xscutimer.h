...
typedef struct {
	...
	uint32_t IsStarted;		/**< Device timer is running */
} XScuTimer;
...
*
* @note		C-style signature:
*		void XScuTimer_LoadTimer(XScuTimer *InstancePtr, uint32_t Value)
*
******************************************************************************/
...
*
* @note		C-style signature:
		uint32_t XScuTimer_GetCounterValue(XScuTimer *InstancePtr)
*
******************************************************************************/
 ...
 */
uint32_t XScuTimer_SelfTest(XScuTimer *InstancePtr);

/*
 * Interface functions in xscutimer.c
 */
uint32_t XScuTimer_CfgInitialize(XScuTimer *InstancePtr,
			    XScuTimer_Config *ConfigPtr, uint32_t EffectiveAddress);
void XScuTimer_Start(XScuTimer *InstancePtr);
void XScuTimer_Stop(XScuTimer *InstancePtr);
void XScuTimer_SetPrescaler(XScuTimer *InstancePtr, uint8_t PrescalerValue);
uint8_t XScuTimer_GetPrescaler(XScuTimer *InstancePtr);
