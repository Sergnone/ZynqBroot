...
#define RESP_NONE	(uint32_t)XSDPS_CMD_RESP_NONE_MASK
#define RESP_R1		(uint32_t)XSDPS_CMD_RESP_L48_MASK | (uint32_t)XSDPS_CMD_CRC_CHK_EN_MASK | \
	(uint32_t)XSDPS_CMD_INX_CHK_EN_MASK

#define RESP_R1B	(uint32_t)XSDPS_CMD_RESP_L48_BSY_CHK_MASK | \
	(uint32_t)XSDPS_CMD_CRC_CHK_EN_MASK | (uint32_t)XSDPS_CMD_INX_CHK_EN_MASK

#define RESP_R2		(uint32_t)XSDPS_CMD_RESP_L136_MASK | (uint32_t)XSDPS_CMD_CRC_CHK_EN_MASK
#define RESP_R3		(uint32_t)XSDPS_CMD_RESP_L48_MASK

#define RESP_R6		(uint32_t)XSDPS_CMD_RESP_L48_BSY_CHK_MASK | \
	(uint32_t)XSDPS_CMD_CRC_CHK_EN_MASK | (uint32_t)XSDPS_CMD_INX_CHK_EN_MASK
...
#define XSDPS_MMC_PART_CFG_0_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24U) \
	| ((uint32_t)EXT_CSD_PART_CONFIG_BYTE << 16U) \
	| ((uint32_t)(0U) << 8U))

#define XSDPS_MMC_PART_CFG_1_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24U) \
	| ((uint32_t)EXT_CSD_PART_CONFIG_BYTE << 16U) \
	| ((uint32_t)EXT_CSD_PART_CONFIG_ACC_BOOT0 << 8U))

#define XSDPS_MMC_PART_CFG_2_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24U) \
	| ((uint32_t)EXT_CSD_PART_CONFIG_BYTE << 16U) \
	| ((uint32_t)EXT_CSD_PART_CONFIG_ACC_BOOT1 << 8U))

#define XSDPS_MMC_START_SANITIZE_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24U) \
	| ((uint32_t)EXT_CSD_SANIT_CONFIG_BYTE << 16U) \
	| ((uint32_t)EXT_CSD_SANITIZE_START << 8U))
 ...
 */
#define XSDPS_MMC_DEF_SPEED_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_HS_TIMING_BYTE << 16) \
	| ((uint32_t)EXT_CSD_HS_TIMING_DEF << 8))

#define XSDPS_MMC_HIGH_SPEED_ARG	(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_HS_TIMING_BYTE << 16) \
	| ((uint32_t)EXT_CSD_HS_TIMING_HIGH << 8))

#define XSDPS_MMC_HS200_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_HS_TIMING_BYTE << 16) \
	| ((uint32_t)EXT_CSD_HS_TIMING_HS200 << 8))

#define XSDPS_MMC_HS400_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_HS_TIMING_BYTE << 16) \
	| ((uint32_t)EXT_CSD_HS_TIMING_HS400 << 8))

#define XSDPS_MMC_1_BIT_BUS_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_BYTE << 16) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_1_BIT << 8))

#define XSDPS_MMC_4_BIT_BUS_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_BYTE << 16) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_4_BIT << 8))

#define XSDPS_MMC_8_BIT_BUS_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_BYTE << 16) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_8_BIT << 8))

#define XSDPS_MMC_DDR_4_BIT_BUS_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_BYTE << 16) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_DDR_4_BIT << 8))

#define XSDPS_MMC_DDR_8_BIT_BUS_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_BYTE << 16) \
	| ((uint32_t)EXT_CSD_BUS_WIDTH_DDR_8_BIT << 8))

#define XSDPS_MMC_RST_FUN_EN_ARG		(((uint32_t)XSDPS_EXT_CSD_WRITE_BYTE << 24) \
	| ((uint32_t)EXT_CSD_RST_N_FUN_BYTE << 16) \
	| ((uint32_t)EXT_CSD_RST_N_FUN_PERM_EN << 8))
...
*		    uint32_t XSdPs_ReadReg(XSdPs *InstancePtr. uint32_t RegOffset)
*
******************************************************************************/
...
*
* @note		C-Style signature:
*		    void XSdPs_WriteReg(XSdPs *InstancePtr, uint32_t RegOffset,
...
*
* @note		C-Style signature:
*		    uint32_t XSdPs_ReadReg(uint32_t BaseAddress. int RegOffset)
*
******************************************************************************/
#define XSdPs_ReadReg(BaseAddress, RegOffset) \
	XSdPs_In32((uint32_t)(BaseAddress) + (uint32_t)(RegOffset))
...
*
* @note		C-Style signature:
*		    void XSdPs_WriteReg(uint32_t BaseAddress, int RegOffset,
*		    uint32_t RegisterValue)
*
******************************************************************************/
#define XSdPs_WriteReg(BaseAddress, RegOffset, RegisterValue) \
	XSdPs_Out32((uint32_t)(BaseAddress) + (uint32_t)(RegOffset), (RegisterValue))
...
*
* @note		C-Style signature:
*		    uint16_t XSdPs_ReadReg(uint32_t BaseAddress. int RegOffset)
*
******************************************************************************/
static INLINE uint16_t XSdPs_ReadReg16(uint32_t BaseAddress, uint8_t RegOffset)
{
#if defined (__MICROBLAZE__) || defined (__riscv)
	uint32_t Reg;
	...
	return (uint16_t)Reg;
#else
	return XSdPs_In16((uint32_t)(BaseAddress) + (uint32_t)(RegOffset));
#endif
}
...
static INLINE void XSdPs_WriteReg16(uint32_t BaseAddress, uint8_t RegOffset, uint16_t RegisterValue)
{
#if defined (__MICROBLAZE__) || defined (__riscv)
	uint32_t Reg;
	BaseAddress += RegOffset & 0xFC;
...
#else
	XSdPs_Out16((uint32_t)(BaseAddress) + (uint32_t)(RegOffset), (RegisterValue));
#endif
}
...
*
* @note		C-Style signature:
*		    uint8_t XSdPs_ReadReg(uint32_t BaseAddress. int RegOffset)
*
******************************************************************************/
static INLINE uint8_t XSdPs_ReadReg8(uint32_t BaseAddress, uint8_t RegOffset)
{
#if defined (__MICROBLAZE__) || defined (__riscv)
	uint32_t Reg;
	BaseAddress += RegOffset & 0xFC;
	...
	return (uint8_t)Reg;
#else
	return XSdPs_In8((uint32_t)(BaseAddress) + (uint32_t)(RegOffset));
#endif
}
/***************************************************************************/
/**
...
*
******************************************************************************/
static INLINE void XSdPs_WriteReg8(uint32_t BaseAddress, uint8_t RegOffset, uint8_t RegisterValue)
{
#if defined (__MICROBLAZE__) || defined (__riscv)
	uint32_t Reg;
	BaseAddress += RegOffset & 0xFC;
	...
	XSdPs_Out32(BaseAddress, Reg);
#else
	XSdPs_Out8((uint32_t)(BaseAddress) + (uint32_t)(RegOffset), (RegisterValue));
#endif
}
/***************************************************************************/
/**
