 ...
 */
#ifndef SDT
int XVFrmbufRd_Initialize(XV_FrmbufRd_l2 *InstancePtr, uint16_t DeviceId)
#else
int XVFrmbufRd_Initialize(XV_FrmbufRd_l2 *InstancePtr, uintptr_t BaseAddress)
#endif
{
	int Status;
 ...
 */
void XVFrmbufRd_InterruptEnable(XV_FrmbufRd_l2 *InstancePtr, uint32_t IrqMask)
{
 ...
 * @note The InstancePtr must not be NULL.
 */
void XVFrmbufRd_InterruptDisable(XV_FrmbufRd_l2 *InstancePtr, uint32_t IrqMask)
{
	Xil_AssertVoid(InstancePtr != NULL);
 ...
 *
 ******************************************************************************/
uintptr_t XVFrmbufRd_GetBufferAddr(XV_FrmbufRd_l2 *InstancePtr)
{
	uintptr_t ReadVal = 0;
...
*
******************************************************************************/
uintptr_t XVFrmbufRd_GetVChromaBufferAddr(XV_FrmbufRd_l2 *InstancePtr)
{
	uintptr_t ReadVal = 0;
 ...
 *
 ******************************************************************************/
uintptr_t XVFrmbufRd_GetChromaBufferAddr(XV_FrmbufRd_l2 *InstancePtr)
{
	uintptr_t ReadVal = 0;
 ...
 */
uint32_t XVFrmbufRd_GetFieldID(XV_FrmbufRd_l2 *InstancePtr)
{
	uint32_t ReadVal;
 ...
 */
int XVFrmbufRd_Set_FidOutMode(XV_FrmbufRd_l2 *InstancePtr, uint32_t fidmodeval)
{
	int Status = XST_FAILURE;
 ...
 */
uint32_t XVFrmbufRd_Get_FidOutMode(XV_FrmbufRd_l2 *InstancePtr)
{
	uint32_t ReadVal;
 ...
 */
uint32_t XVFrmbufRd_Get_FidErrorOut(XV_FrmbufRd_l2 *InstancePtr)
{
	uint32_t ReadVal;
 ...
 *          Frame Buffer Read core is configured for interlaced mode.
 */
uint32_t XVFrmbufRd_Get_FidErrorCount(XV_FrmbufRd_l2 *InstancePtr)
{
	uint32_t ReadVal;
 ...
 *
 */
uint32_t XVFrmbufRd_Get_FieldOut(XV_FrmbufRd_l2 *InstancePtr)
{
	uint32_t ReadVal;
 ...
 * configuration and runtime status to the console using printf. The report includes
