...
int32 XGpioPs_SelfTest(XGpioPs *InstancePtr)
{
	...
	uint32_t CurrentIntrType = 0U;
	uint32_t CurrentIntrPolarity = 0U;
	uint32_t CurrentIntrOnAny = 0U;
	uint32_t IntrType = 0U;
	uint32_t IntrPolarity = 0U;
	uint32_t IntrOnAny = 0U;
	uint32_t IntrTestValue = 0x22U;
