...
*                       structure
* 7.2   sk     08/16/16 Used uint32_t instead of uint32_t for Baseaddress as part of
...
*
* @note		C-style signature:
*		uint32_t XVtc_GetDetectionStatus(XVtc *InstancePtr)
*
******************************************************************************/
...
*		C-style signature:
*		void XVtc_IntrEnable(XVtc *InstancePtr, uint32_t IntrType)
*
******************************************************************************/
...
*		C-style signature:
*		void XVtc_IntrDisable(XVtc *InstancePtr, uint32_t IntrType)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		uint32_t XVtc_StatusGePending(XVtc *InstancePtr)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		uint32_t XVtc_IntrGetPending(XVtc *InstancePtr)
*
******************************************************************************/
...
*
* @note		C-style signature:
*		void XVtc_IntrClear(XVtc *InstancePtr, uint32_t IntrType)
*
******************************************************************************/
...
void XVtc_ConvVideoMode2Timing(XVtc *InstancePtr, uint16_t Mode,
...
void XVtc_ConvSignal2Timing(XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr,
		...
		XVtc_Timing *TimingPtr);
uint16_t XVtc_ConvTiming2VideoMode(XVtc *InstancePtr, XVtc_Timing *TimingPtr);

/* Timing/Video Mode Setting/Fetching */
void XVtc_SetGeneratorTiming(XVtc *InstancePtr, XVtc_Timing * TimingPtr);
void XVtc_SetGeneratorVideoMode(XVtc *InstancePtr, uint16_t Mode);
void XVtc_GetGeneratorTiming(XVtc *InstancePtr, XVtc_Timing *TimingPtr);
uint16_t  XVtc_GetGeneratorVideoMode(XVtc *InstancePtr);
void XVtc_GetDetectorTiming(XVtc *InstancePtr, XVtc_Timing *TimingPtr);
uint16_t  XVtc_GetDetectorVideoMode(XVtc *InstancePtr);
...
/* Frame Sync setting */
void XVtc_SetFSync(XVtc *InstancePtr, uint16_t FrameSyncIndex,
			   uint16_t VertStart, uint16_t HoriStart);
void XVtc_GetFSync(XVtc *InstancePtr, uint16_t FrameSyncIndex,
...
/* Version function */
uint32_t XVtc_GetVersion(XVtc *InstancePtr);

/* Initialization functions in xvtc_sinit.c */
XVtc_Config *XVtc_LookupConfig(uint32_t BaseAddress);

/*
 * Interrupt related function(s) in xvtc_intr.c
 */
void XVtc_IntrHandler(void *InstancePtr);
int XVtc_SetCallBack(XVtc *InstancePtr, uint32_t IntrType,
...
void XVtc_SetVfpStretchLimit(XVtc *InstancePtr, uint32_t StretchLimit);
