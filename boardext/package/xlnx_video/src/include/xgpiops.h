...
* 3.14  bkv  02/20/25 Changed data type of effective address from uint32_t to uint32_t
...
uint32_t XGpioPs_CfgInitialize(XGpioPs *InstancePtr, const XGpioPs_Config *ConfigPtr,
...
uint32_t XGpioPs_SelfTest(XGpioPs *InstancePtr);
