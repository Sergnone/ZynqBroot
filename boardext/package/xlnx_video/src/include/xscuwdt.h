...
typedef struct {
	...
	uint32_t IsStarted;		/**< Device watchdog timer is running */
} XScuWdt;
...
*
* @note		C-style signature:
*		void XScuWdt_LoadWdt(XScuWdt *InstancePtr, uint32_t Value)
*
******************************************************************************/
...
*
* @note		C-style signature:
		uint32_t XScuWdt_GetControlReg(XScuWdt *InstancePtr)
*
******************************************************************************/
...
*
* @note		C-style signature:
		void XScuWdt_SetControlReg(XScuWdt *InstancePtr, uint32_t ControlReg)
*
******************************************************************************/
 ...
 */
uint32_t XScuWdt_SelfTest(XScuWdt *InstancePtr);

/*
 * Interface functions in xscuwdt.c
 */
uint32_t XScuWdt_CfgInitialize(XScuWdt *InstancePtr,
			  XScuWdt_Config *ConfigPtr, uint32_t EffectiveAddress);
