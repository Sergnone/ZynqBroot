...
*					  uint32_t which resolves issue of CR#805869
...
void Xil_SetTlbAttributes(INTPTR Addr, uint32_t attrib);
void Xil_EnableMMU(void);
void Xil_DisableMMU(void);
void* Xil_MemMap(uint32_t PhysAddr, size_t size, uint32_t flags);
