...
void Xpm_SetEvents(uint32_t PmcrCfg);
void Xpm_GetEventCounters(uint32_t *PmCtrValue);
uint32_t Xpm_DisableEvent(uint32_t EventCntrId);
void Xpm_DisableEventCounters(void);
void Xpm_EnableEventCounters (void);
void Xpm_ResetEventCounters (void);
uint32_t Xpm_SetUpAnEvent(uint32_t EventID);
uint32_t Xpm_GetEventCounter(uint32_t EventCntrId, uint32_t *CntVal);
