...
*
******************************************************************************/
void XVersion_UnPack(XVersion *InstancePtr, uint16_t PackedVersion)
{
	(void) InstancePtr;
	(void) PackedVersion;
...
*
******************************************************************************/
int XVersion_Pack(XVersion *InstancePtr, uint16_t *PackedVersionPtr)
{
	/* not implemented yet since CROM related */
	(void) InstancePtr;
...
{
	uint8_t *Version1 = (uint8_t *) InstancePtr;
	uint8_t *Version2 = (uint8_t *) VersionPtr;
	uint32_t Index;
...
{
	uint8_t *Source = (uint8_t *) InstancePtr;
	uint8_t *Destination = (uint8_t *) VersionPtr;
	uint32_t Index;
