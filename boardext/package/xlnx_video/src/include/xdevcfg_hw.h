...
*		uint32_t XDcfg_ReadReg(uint32_t BaseAddr, uint32_t RegOffset)
*
*****************************************************************************/
...
*
* @note		C-style signature:
*		void XDcfg_WriteReg(uint32_t BaseAddr, uint32_t RegOffset, uint32_t Data)
*
*****************************************************************************/
 ...
 */
void XDcfg_ResetHw(uint32_t BaseAddr);
