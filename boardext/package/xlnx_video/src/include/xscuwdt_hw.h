...
*		uint32_t XScuWdt_ReadReg(uint32_t BaseAddr, uint32_t RegOffset)
*
*****************************************************************************/
#define XScuWdt_ReadReg(BaseAddr, RegOffset)		\
	Xil_In32((BaseAddr) + ((uint32_t)RegOffset))
...
*
* @note		C-style signature:
*		void XScuWdt_WriteReg(uint32_t BaseAddr, uint32_t RegOffset, uint32_t Data)
*
*****************************************************************************/
#define XScuWdt_WriteReg(BaseAddr, RegOffset, Data)	\
	Xil_Out32((BaseAddr) + ((uint32_t)RegOffset), ((uint32_t)Data))
