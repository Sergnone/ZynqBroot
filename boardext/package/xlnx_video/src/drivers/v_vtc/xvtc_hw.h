...
*		uint32_t XVtc_ReadReg(uint32_t BaseAddress, uint32_t RegOffset)
*
******************************************************************************/
#define XVtc_ReadReg(BaseAddress, RegOffset) \
		XVtc_In32((BaseAddress) + ((uint32_t)RegOffset))
...
*
* @note		C-style signature:
*		void XVtc_WriteReg(uint32_t BaseAddress, uint32_t RegOffset, uint32_t Data)
*
******************************************************************************/
#define XVtc_WriteReg(BaseAddress, RegOffset, Data) 	\
		XVtc_Out32((BaseAddress) + ((uint32_t)RegOffset), (uint32_t)(Data))
/*@}*/
