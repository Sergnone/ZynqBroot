...
# Package metadata
DYNCLK_VERSION = 1.0
DYNCLK_SITE = /home/serg/Documents/Xilinx/ZynqBroot/boardext/package/dglntdynclk/src
...
define DYNCLK_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0755 $(@D)/dglntdynclk.ko $(TARGET_DIR)/lib/modules/$(LINUX_VERSION_PROBED)/
endef
